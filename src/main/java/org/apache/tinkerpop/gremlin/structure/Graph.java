    ...
    public interface Variables {
        ...
        public default Map<String, Object> asMap() {
            final Map<String, Object> map = keys().stream()
                    .map(new Function<String, Pair<String, Object>>() {
                        @Override
                        public Pair<String, Object> apply(String key) {
                            return Pair.with(key, Variables.this.get(key).get());
                        }
                    })
                    .collect(Collectors.toMap(new Function<Pair<String, Object>, String>() {
                        @Override
                        public String apply(Pair<String, Object> objects) {
                            return objects.getValue0();
                        }
                    }, new Function<Pair<String, Object>, Object>() {
                        @Override
                        public Object apply(Pair<String, Object> objects) {
