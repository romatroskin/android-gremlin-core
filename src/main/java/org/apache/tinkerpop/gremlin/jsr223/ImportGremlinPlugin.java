...
public final class ImportGremlinPlugin extends AbstractGremlinPlugin {
    ...
    public static final class Builder {
                        ...
                        Stream.of(clazz.getEnumConstants())
                                .filter(new Predicate<Object>() {
                                    ...
                                    public boolean test(Object o) {
                                        return ((Enum) o).name().equals(enumValString);
                                    }
                                }).findFirst().ifPresent(new Consumer<Object>() {
                            @Override
                            public void accept(Object o) {
                                enumImports.add((Enum) o);
                            }
                        });
                    }
                } catch (IllegalArgumentException iae) {
        ...
        private static List<Enum> allEnums(final Class<?> clazz) {
            return Stream.of(clazz.getEnumConstants()).map(new Function<Object, Enum>() {
                @Override
                public Enum apply(Object o) {
                    return (Enum) o;
                }
        ...
        private static List<Method> allStaticMethods(final Class<?> clazz) {
            return Stream.of(clazz.getMethods()).filter(new Predicate<Method>() {
                @Override
        ...
        private static Class<?>[] parse(final String argString) {
            ...
            final List<String> args = Stream.of(argString.split(",")).map(new Function<String, String>() {
                @Override
